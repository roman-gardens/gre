...
{{< image file="Bancroft_fig_1.jpg" caption="Fig. 1: Plan of the villa with its garden courtyard (G), a central pool (P), and a possible gazebo (A)." credit="Adapted from Zeepvat 1991, fig. 5.4." alt="Fig. 1: Plan of the villa with its garden courtyard (G), a central pool (P), and a possible gazebo (A). Adapted from Zeepvat 1991, fig. 5.4." >}}
